...
- 战斗胜利得**金币** + **三选一卡牌奖励**，并有概率掉落**药水**；精英 / 首领给更多更好。
- **药水**（消耗品，默认 3 格）：战斗中点击使用——易伤/虚弱/脆弱（给敌人 3 层）、
  力量/敏捷（给自己 2 层）、抽取（抽 3 张）。
- **休息点**：回血 或 升级一张卡。**商店**：花金币买卡 / 升级卡 / 治疗（初始 99 金币，卖价已下调）。
...
升级一张卡 = 加一个**随机等级**的新词条（每卡最多 3 个词条；词条一旦获得就不再升级）。
