...
CG.CONFIG = {
  ...
  packW: {
    monster: [['basic', 6], ['power', 2], ['weaken', 2], ['tempo', 2], ['vitality', 2], ['elements', 1], ['cook', 1], ['exhaust', 1], ['elec', 1], ['bastion', 1], ['produce', 1]],
    elite:   [['basic', 2], ['power', 3], ['weaken', 3], ['tempo', 3], ['vitality', 3], ['elements', 2], ['cook', 2], ['exhaust', 2], ['elec', 2], ['bastion', 2], ['produce', 2]],
    boss:    [['basic', 1], ['power', 3], ['weaken', 3], ['tempo', 3], ['vitality', 3], ['elements', 2], ['cook', 2], ['exhaust', 2], ['elec', 2], ['bastion', 2], ['produce', 2]],
  },
