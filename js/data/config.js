...
CG.CONFIG = {
  ...
  packW: {
    monster: [['basic', 6], ['power', 2], ['weaken', 2], ['tempo', 2], ['vitality', 2], ['elements', 1], ['cook', 1], ['exhaust', 1], ['elec', 1], ['bastion', 1], ['produce', 1], ['retain', 1], ['enhance', 1], ['void', 1], ['gadget', 1], ['econ', 1], ['miner', 1], ['forge', 1], ['summon', 1], ['build', 1], ['discard', 1], ['conjure', 1], ['hunter', 1]],
    elite:   [['basic', 2], ['power', 3], ['weaken', 3], ['tempo', 3], ['vitality', 3], ['elements', 2], ['cook', 2], ['exhaust', 2], ['elec', 2], ['bastion', 2], ['produce', 2], ['retain', 2], ['enhance', 2], ['void', 2], ['gadget', 2], ['econ', 2], ['miner', 2], ['forge', 2], ['summon', 2], ['build', 2], ['discard', 2], ['conjure', 2], ['hunter', 2]],
    boss:    [['basic', 1], ['power', 3], ['weaken', 3], ['tempo', 3], ['vitality', 3], ['elements', 2], ['cook', 2], ['exhaust', 2], ['elec', 2], ['bastion', 2], ['produce', 2], ['retain', 2], ['enhance', 2], ['void', 2], ['gadget', 2], ['econ', 2], ['miner', 2], ['forge', 2], ['summon', 2], ['build', 2], ['discard', 2], ['conjure', 2], ['hunter', 2]],
  },
