...
(function (CG) {
  CG.RELICS = {
    ...
    deaths_touch:{ name: '死神之触', icon: '🩻', desc: '你的每次攻击伤害 +2', attackBonus: 2 },
    moms_knife:  { name: '妈妈的刀', icon: '🔪', desc: '你的每次攻击伤害 +3', attackBonus: 3 },
    crickets:    { name: '蟋蟀之头', icon: '🦗', desc: '你的攻击伤害 +25%', attackMult: 1.25 },
    polyphemus:  { name: '独眼巨人', icon: '🦠', desc: '你的攻击伤害 +50%', attackMult: 1.5 },
    ...
    // —— 家族（每回合开始攻击敌人）——
    brother_bobby:{ name: '兄弟鲍比', icon: '👶', desc: '每回合开始对敌人造成 4 点伤害', turnDamage: 4 },
    little_steven:{ name: '小斯蒂文', icon: '🧒', desc: '每回合开始对敌人造成 3 点伤害', turnDamage: 3 },
    sac_dagger:  { name: '献祭匕首', icon: '🔱', desc: '每回合开始对敌人造成 6 点伤害', turnDamage: 6 },
    // —— 防御 / 续航 ——
    ...
    eternal_heart:{ name: '永恒之心', icon: '💟', desc: '每回合开始获得 4 格挡', blockTurn: 4 },
    ...
    dinner:      { name: '晚餐', icon: '🍖', desc: '最大生命 +8', onPickup: r => { r.maxHp += 8; r.hp += 8; } },
    // —— 能量 / 经济 / 消耗 ——
